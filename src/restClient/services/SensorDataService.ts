...
export class SensorDataService {
     ...
     * @throws ApiError
     */
    public static getInputStateByZoneAndDevice(
        zoneId: string,
        deviceId: string,
    ): CancelablePromise<'OPEN' | 'CLOSED'> {
     ...
     * @throws ApiError
     */
    public static getBrightnessByZoneAndDevice(
        zoneId: string,
        deviceId: string,
     ...
     * @throws ApiError
     */
    public static getIntensityByZoneAndDevice(
        zoneId: string,
        deviceId: string,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static getPresenceByZoneAndDevice(
        zoneId: string,
        deviceId: string,
     ...
     * @throws ApiError
     */
    public static getAverageNoiseByZoneAndDevice(
        zoneId: string,
        deviceId: string,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static getMinimumNoiseByZoneAndDevice(
        zoneId: string,
        deviceId: string,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static getMaximumNoiseByZoneAndDevice(
        zoneId: string,
        deviceId: string,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static getCo2ByZoneAndDevice(
        zoneId: string,
        deviceId: string,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static getVocByZoneAndDevice(
        zoneId: string,
        deviceId: string,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static getHumidityByZoneAndDevice(
        zoneId: string,
        deviceId: string,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static getRelativeHumidityByZoneAndDevice(
        zoneId: string,
        deviceId: string,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static getTemperatureByZoneAndDevice(
        zoneId: string,
        deviceId: string,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static getLeveledTemperatureByZoneAndDevice(
        zoneId: string,
        deviceId: string,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
